Feature: Homepage feature
  ...
  Scenario: Verify Home page opens fine
    Given I navigate to the Home page
    Then Check if current URL is HomePage URL

  Scenario: Check if all page elements on Home page are presents
    Given I navigate to the Home page
    Then Check all page element on Home page are present

      #Не работает проверка элементов на странице
  Scenario: Check if login and logout as Guest is possible
    Given I navigate to the Home page
    ...
    Then User logout and Home Page Url check
      ...
      #Не работает проверка элементов на странице
  Scenario: Check if login and logout as Registered User is possible
    Given I navigate to the Home page
